...
#Standard imports. DEBUG
import sys #Could remove later
from PyQt5 import uic #essential for mainwindow.ui
from PyQt5.QtCore import pyqtSlot #Needs to stay for connection.
